...
if __name__ == "__main__":
    ...
    parser.add_argument("domain", help="The domain to enumerate subdomains for (e.g., example.com)")

    args = parser.parse_args()
    domain_to_search = args.domain
    subdomains = crtsh_subdomain_enum(domain_to_search)

    if subdomains:
        print(f"Subdomains found for {domain_to_search}:")
        for subdomain in subdomains:
            print(subdomain)
    else:
        print(f"No subdomains found for {domain_to_search}.")
